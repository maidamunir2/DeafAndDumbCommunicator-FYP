...
public class OfficeItemDetailActivity extends AppCompatActivity {

    ImageView imageView;
    TextView textView;

    OfficeModel dataModel;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_office_item_detail);

        imageView = findViewById(R.id.officeItemDetail_img);
        textView = findViewById(R.id.officeItemDetail_txt);
        ...
        dataModel = (OfficeModel) getIntent().getSerializableExtra("Data");
